...
function runFunction(name, input)
{
    switch (name) {
        ...
        case 'decodeChangeState':
            return codec.decodeChangeState(input)
        case 'decodeEventLogging':
            return codec.decodeEventLogging(input)
        case 'encodeDeviceConfiguration':
            return codec.encodeDeviceConfiguration(input)
        case 'encodePeriodicPackage':
            return codec.encodePeriodicPackage(input)
        case 'encodeDynamicLimitControl':
            return codec.encodeDynamicLimitControl(input)
        case 'encodeRelayControl':
            return codec.encodeRelayControl(input)
        case 'encodeRequestSettings':
            return codec.encodeRequestSettings(input)
        default:
            break;
    }
