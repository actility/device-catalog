...
> If you have a driver already follows the LoRa Alliance standard codec API, then you need just to add `driver.yaml` file as the one [here](sd01-l-v2/driver.yaml).
...
> A pre-implemented [spec file](sd01-l-v2/driver-examples.spec.js) for testing can be copied from the template in order to test the driver with all the provided examples.
...
In order to facilitate the use cases testing process, we provide the file [driver-examples.spec.js](sd01-l-v2/driver-examples.spec.js).
