...
function handle_downlink_response(channel_type, bytes, offset) {
    ...
    switch (channel_type) {
        ...
        case 0x06:
            ...
            var condition_type = (data >>> 0) & 0x07;
            var alarm_type = (data >>> 3) & 0x07;
            var enable_type = (data >>> 6) & 0x01;
            if (alarm_type === 0x01) {
                decoded.temperature_alarm_config = {};
                decoded.temperature_alarm_config.enable = readEnableStatus(enable_type);
                ...
                decoded.temperature_mutation_alarm_config.enable = readEnableStatus(enable_type);
