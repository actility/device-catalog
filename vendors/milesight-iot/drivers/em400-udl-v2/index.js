...
function handle_downlink_response(channel_type, bytes, offset) {
    ...
    switch (channel_type) {
        ...
        case 0x06:
            ...
            decoded.standard_mode_alarm_config = {};
            decoded.standard_mode_alarm_config.condition = readMathConditionType(condition_type);
            decoded.standard_mode_alarm_config.alarm_release_enable = readEnableStatus((value >>> 7) & 0x01);
            decoded.standard_mode_alarm_config.threshold_min = readUInt16LE(bytes.slice(offset + 1, offset + 3));
            decoded.standard_mode_alarm_config.threshold_max = readUInt16LE(bytes.slice(offset + 3, offset + 5));
            // skip 4 bytes
            offset += 9;
            break;
        case 0x10:
