...
function milesightDeviceEncode(payload) {
	...
	if ('temperature' in payload) {
		...
		if (payload.temperature < -200 || payload.temperature > 800) {
			throw new Error('temperature must be between -200 and 800');
		}
	...
	if ('temperature_alarm' in payload) {
		...
		if (payload.temperature_alarm.type == 0x11) {
			if (payload.temperature_alarm.lower_range_alarm_trigger.temperature < -200 || payload.temperature_alarm.lower_range_alarm_trigger.temperature > 800) {
				throw new Error('temperature_alarm.lower_range_alarm_trigger.temperature must be between -200 and 800');
			}
		...
		if (payload.temperature_alarm.type == 0x12) {
			if (payload.temperature_alarm.over_range_alarm_deactivation.temperature < -200 || payload.temperature_alarm.over_range_alarm_deactivation.temperature > 800) {
				throw new Error('temperature_alarm.over_range_alarm_deactivation.temperature must be between -200 and 800');
			}
		...
		if (payload.temperature_alarm.type == 0x13) {
			if (payload.temperature_alarm.over_range_alarm_trigger.temperature < -200 || payload.temperature_alarm.over_range_alarm_trigger.temperature > 800) {
				throw new Error('temperature_alarm.over_range_alarm_trigger.temperature must be between -200 and 800');
			}
		...
		if (payload.temperature_alarm.type == 0x14) {
			if (payload.temperature_alarm.within_range_alarm_deactivation.temperature < -200 || payload.temperature_alarm.within_range_alarm_deactivation.temperature > 800) {
				throw new Error('temperature_alarm.within_range_alarm_deactivation.temperature must be between -200 and 800');
			}
		...
		if (payload.temperature_alarm.type == 0x15) {
			if (payload.temperature_alarm.within_range_alarm_trigger.temperature < -200 || payload.temperature_alarm.within_range_alarm_trigger.temperature > 800) {
				throw new Error('temperature_alarm.within_range_alarm_trigger.temperature must be between -200 and 800');
			}
		...
		if (payload.temperature_alarm.type == 0x16) {
			if (payload.temperature_alarm.exceed_range_alarm_deactivation.temperature < -200 || payload.temperature_alarm.exceed_range_alarm_deactivation.temperature > 800) {
				throw new Error('temperature_alarm.exceed_range_alarm_deactivation.temperature must be between -200 and 800');
			}
		...
		if (payload.temperature_alarm.type == 0x17) {
			if (payload.temperature_alarm.exceed_range_alarm_trigger.temperature < -200 || payload.temperature_alarm.exceed_range_alarm_trigger.temperature > 800) {
				throw new Error('temperature_alarm.exceed_range_alarm_trigger.temperature must be between -200 and 800');
			}
		...
		if (payload.temperature_alarm.type == 0x30) {
			if (payload.temperature_alarm.mutation_alarm_trigger_no_mutation.temperature < -200 || payload.temperature_alarm.mutation_alarm_trigger_no_mutation.temperature > 800) {
				throw new Error('temperature_alarm.mutation_alarm_trigger_no_mutation.temperature must be between -200 and 800');
			}
		...
		if (payload.temperature_alarm.type == 0x20) {
			if (payload.temperature_alarm.mutation_alarm_trigger.temperature < -200 || payload.temperature_alarm.mutation_alarm_trigger.temperature > 800) {
				throw new Error('temperature_alarm.mutation_alarm_trigger.temperature must be between -200 and 800');
			}
			buffer.writeInt32LE(payload.temperature_alarm.mutation_alarm_trigger.temperature * 100);
			if (payload.temperature_alarm.mutation_alarm_trigger.saltation < -200 || payload.temperature_alarm.mutation_alarm_trigger.saltation > 800) {
				throw new Error('temperature_alarm.mutation_alarm_trigger.saltation must be between -200 and 800');
			}
	...
	if ('temperature_alarm_settings' in payload) {
		...
		if (payload.temperature_alarm_settings.threshold_max < -200 || payload.temperature_alarm_settings.threshold_max > 800) {
			throw new Error('temperature_alarm_settings.threshold_max must be between -200 and 800');
		}
