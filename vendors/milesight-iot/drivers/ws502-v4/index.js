...
function handle_downlink_response_ext(code, channel_type, bytes, offset) {
    ...
    switch (channel_type) {
        ...
        case 0xab:
            ...
            offset += 1;
            var power_bit_offset = [ "button_power1", "button_power2" ];
...
function readScheduleSettings(bytes, isReport) {
    ...
    // action
    var switch_bit_offset = { button_status1: 0, button_status2: 2 };
...
function readButtonId(button_id) {
    var button_id_map = { 0: "button1", 1: "button2" };
 ...
 * @example { "button_status_control": { "button_status1": 1, "button_status2": 1, "button_status1_change": 1, "button_status2_change": 1 } }
 */
 ...
 * @example { "power_consumption_2w": {"button_power1": 0, "button_power2": 1100 } }
 */
function setPowerConsumption(power_consumption_2w) {
    ...
    var powers = [ "button_power1", "button_power2" ];
 ...
 * @example { "schedule_settings": [{ "schedule_id": 1, "enable": 1, "use_config": 1, "monday": 1, "tuesday": 0, "wednesday": 1, "thursday": 0, "friday": 1, "saturday": 0, "sunday": 1, "execut_hour": 10, "execut_min": 5, "button_status1": 1, "button_status2": 1, "lock_status": 1 }] }
 */
 ...
 * @param {number} d2d_agent_settings_array.action_status.button values: (1: "button1", 2: "button2", 3: "button1, button2")
...
function setD2DAgentSettings(d2d_agent_settings) {
    ...
    var button_map = {1: "button1", 2: "button2", 3: "button1, button2"};
 ...
 * @param {number} d2d_controller_settings_array.button_id values: (0: "button1", 1: "button2")
