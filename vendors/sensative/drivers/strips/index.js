...
const translator = {
    decodeLoraStripsDownlink,
    decodeLoraStripsUplink,
    encodeLoraStripsDownlink,
};
...
const transformTable = {
    ...
    statusCode:              { func: (r, o) => { r.statusCode = o.value; r.statusText = o.status; } },
};
...
function decodeUplink(input) {
    ...
    case 1:
    case 11:
        returned = translator.decodeLoraStripsUplink(port, input.bytes);
        break;
    case 2:
...
function decodeDownlink(input) {
    const port = parseInt(input.fPort);
    return transformStripsDecodeDownlinkToActilityFormat(translator.decodeLoraStripsDownlink(port, input.bytes));
}
