...
const packetTypes = {
    ...
    0x4F: ["CMi4140", "DR0 message", "Kamstrup"], // specific to us915 DR0
    ...
    0x50: ["CMi4170", "DR0 message", "Engelmann"], // specific to us915 DR0
};
...
function decodeUplink(input) {
    ...
    try {
        ...
        while (pos < (r.length)) {
            ...
            let map = valueMap[(dif >> 12) == 0x03 ? dif & 0xfff : dif];
