...
{
    const EVENT_PROPERTY_NAMES = ["Ambient_Temp","Surface_Temp","Ambient_Pressure","Ambient_Humidity","Battery","Vib_Accel_X_Axis","Vib_Accel_Y_Axis","Vib_Accel_Z_Axis","Vib_Velocity_X_Axis","Vib_Velocity_Y_Axis","Vib_Velocity_Z_Axis","Audio","License"];
    ...
    if (port == 0x03)
    {
        ...
        var sampling_freq = (byte[38] << 8) | byte[37];
        ...
        return {
            ...
            var_sampling_freq: sampling_freq
        };
    }
    ...
    if (port == 8)
    {
        ...
        else if ((Sensor_Type > 4) && (Sensor_Type <= 11))
        {
            ...
            decoded_8["event_" + EVENT_PROPERTY_NAMES[Sensor_Type] + "Device_Type"] = Device_Type;
            return decoded_8;
        }
        else if (Sensor_Type == 4)
        {
            ...
            if (Event_Type == 0)
                ...
                decoded_8["event_" + EVENT_PROPERTY_NAMES[Sensor_Type] + "_Battery_Life"] = byte[6];
            else if (Event_Type == 4)
                decoded_8["event_" + EVENT_PROPERTY_NAMES[Sensor_Type] + "_low"] = byte[6];
            return decoded_8;
        }
        else if (Sensor_Type == 12)
        {
            decoded_8["event_" + EVENT_PROPERTY_NAMES[Sensor_Type] + "_expiry_date"] = (byte[10] << 24) | (byte[9] << 16) | (byte[8] << 8) | byte[7];
            return decoded_8;
        }
    }
    ...
    if (port == 11)
    {
        ...
        for (let Sensor_Type = 0; Sensor_Type < 13; Sensor_Type++) {
