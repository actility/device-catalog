const PAYLOAD_TYPE = {
  ...
  T1_MME_E_SUM_WH        :  {header: 0x76, size_min: 13/*in bytes*/, size_max: 51/*in bytes*/, name: "T1_MME_E_SUM_WH"},
  T1_MME_E_POS_WH        :  {header: 0x77, size_min: 13/*in bytes*/, size_max: 51/*in bytes*/, name: "T1_MME_E_POS_WH"},
  T1_MME_E_NEG_WH        :  {header: 0x78, size_min: 13/*in bytes*/, size_max: 51/*in bytes*/, name: "T1_MME_E_NEG_WH"},
  T1_MME_E_POS_AND_E_NEG_WH :  {header: 0x79, size_min: 23/*in bytes*/, size_max: 51/*in bytes*/, name: "T1_MME_E_POS_AND_E_NEG_WH"},
