function extractPoints(input) {
                ...
                switch (item.variable) {
                    ...
                    case "active_energy_abc":
                        if (!result["powerRate:4"]) {
                            result["powerRate:4"] = { unitId: "W/h", records: [], nature: "Positive active energy" }
                        }
                    ...
                    case "negative_active_energy_abc":
                        if (!result["powerRate:8"]) {
                            result["powerRate:8"] = { unitId: "W/h", records: [], nature: "Negative active energy" }
                        }
                        result["powerRate:8"].records.push({
                            eventTime: new Date(item.date).toISOString(),
                            value: item.value
                        })
                        break
                    ...
                    case "positive_reactive_energy_abc":
                        if (!result["reactiveEnergy:4"]) {
                            result["reactiveEnergy:4"] = { unitId: "VArh", records: [], nature: "Positive reactive energy" }
                        }
                    ...
                    case "negative_reactive_energy_c":
                        if (!result["reactiveEnergy:7"]) {
                            result["reactiveEnergy:7"] = { unitId: "VArh", records: [], nature: "Negative reactive energy" }
                        }
                    ...
                    case "negative_reactive_energy_abc":
                        if (!result["reactiveEnergy:8"]) {
                            result["reactiveEnergy:8"] = { unitId: "VArh", records: [], nature: "Negative active energy" }
                        }
                        result["reactiveEnergy:8"].records.push({
                            eventTime: new Date(item.date).toISOString(),
                            value: item.value
                        })
                        break
                    ...
                    case "positive_active_power_abc":
                        if (!result["activePower:4"]) {
                            result["activePower:4"] = { unitId: "W", records: [], nature: "Positive active power" }
                        }
                    ...
                    case "negative_active_power_abc":
                        if (!result["activePower:8"]) {
                            result["activePower:8"] = { unitId: "W", records: [], nature: "Negative active power" }
                        }
                        result["activePower:8"].records.push({
                            eventTime: new Date(item.date).toISOString(),
                            value: item.value
                        })
                        break
                    ...
                    case "positive_reactive_power_abc":
                        if (!result["reactivePower:4"]) {
                            result["reactivePower:4"] = { unitId: "VAr", records: [], nature: "Positive reactive power" }
                        }
                    ...
                    case "negative_reactive_power_abc":
                        if (!result["reactivePower:8"]) {
                            result["reactivePower:8"] = { unitId: "VAr", records: [], nature: "Negative reactive power" }
                        }
                        result["reactivePower:8"].records.push({
                            eventTime: new Date(item.date).toISOString(),
                            value: item.value
                        })
                        break
                    ...
                    case "Vrms_c":
                        if (!result["rmsVoltage:3"]) {
                            result["rmsVoltage:3"] = { unitId: "V", records: []}
                        }
                        result["rmsVoltage:3"].records.push({
                            eventTime: new Date(item.date).toISOString(),
                            value: item.value/10
                        })
                        break
                    ...
                    case "Irms_a":
                        if (!result["current:1"]) {
                            result["current:1"] = { unitId: "A", records: [], nature: "Irms A"}
                        }
                    ...
                    case "Irms_b":
                        if (!result["current:2"]) {
                            result["current:2"] = { unitId: "A", records: [], nature: "Irms B"}
                        }
                    ...
                    case "Irms_c":
                        if (!result["current:3"]) {
                            result["current:3"] = { unitId: "A", records: [], nature: "Irms C"}
                        }
                        result["current:3"].records.push({
                            eventTime: new Date(item.date).toISOString(),
                            value: item.value/10
                        })
                        break
                    ...
                    case "angle_a":
                        if (!result["angle:1"]) {
                            result["angle:1"] = { unitId: "A", records: []}
                        }
                    ...
                    case "angle_c":
                        if (!result["angle:3"]) {
                            result["angle:3"] = { unitId: "deg", records: []}
                        }
                        result["angle:3"].records.push({
                            eventTime: new Date(item.date).toISOString(),
                            value: item.value/10
                        })
                        break
    ...
    if(result["powerRate:4"] != null && result["powerRate:4"].records.length === 1) {
        ...
        result["powerRate:4"] = { unitId: "W/h", record: val, nature: "Positive active energy" }
    }
    ...
    if(result["powerRate:8"] != null && result["powerRate:8"].records.length === 1) {
        let val = result["powerRate:8"].records[0].value
        result["powerRate:8"] = { unitId: "W/h", record: val, nature: "Negative active energy" }
    }
    ...
    if(result["reactiveEnergy:4"] != null && result["reactiveEnergy:4"].records.length === 1) {
        ...
        result["reactiveEnergy:4"] = { unitId: "VArh", record: val, nature: "Positive reactive energy" }
    }
    ...
    if(result["reactiveEnergy:8"] != null && result["reactiveEnergy:8"].records.length === 1) {
        let val = result["reactiveEnergy:8"].records[0].value
        result["reactiveEnergy:8"] = { unitId: "VArh", record: val, nature: "Negative reactive energy" }
    }
    ...
    if(result["activePower:4"] != null && result["activePower:4"].records.length === 1) {
        ...
        result["activePower:4"] = { unitId: "W", record: val, nature: "Positive active power" }
    }
    ...
    if(result["activePower:8"] != null && result["activePower:8"].records.length === 1) {
        let val = result["activePower:8"].records[0].value
        result["activePower:8"] = { unitId: "W", record: val, nature: "Negative active power" }
    }
    ...
    if(result["reactivePower:4"] != null && result["reactivePower:4"].records.length === 1) {
        ...
        result["reactivePower:4"] = { unitId: "VAr", record: val, nature: "Positive reactive energy" }
    }
    ...
    if(result["reactivePower:8"] != null && result["reactivePower:8"].records.length === 1) {
        let val = result["reactivePower:8"].records[0].value
        result["reactivePower:8"] = { unitId: "VAr", record: val, nature: "Negative reactive energy" }
    }
    ...
    if(result["rmsVoltage:3"] != null && result["rmsVoltage:3"].records.length === 1) {
        let val = result["rmsVoltage:3"].records[0].value
        result["rmsVoltage:3"] = { unitId: "V", record: val}
    }
    ...
    if(result["angle:3"] != null && result["angle:3"].records.length === 1) {
        let val = result["angle:3"].records[0].value
        result["angle:3"] = { unitId: "deg", record: val}
    }
    ...
    if(result["current:3"] != null && result["current:3"].records.length === 1) {
        let val = result["current:3"].records[0].value
        result["current:3"] = { unitId: "A", record: val}
    }
