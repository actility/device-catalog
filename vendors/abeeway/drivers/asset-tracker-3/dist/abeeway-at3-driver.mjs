...
/* provided dependency */ var Buffer = __webpack_require__(617)["hp"];
...
var require_gnssFix = __commonJS({
  "../../device-catalog/vendors/abeeway/drivers/asset-tracker-3/src/messages/uplink/positions/gnss/gnssFix.js"(exports2, module2) {
    ...
    function determineFixQuality(payload) {
      ...
      qualityInfo.numberSatellitesUsed = payload[15] & 31;
      return qualityInfo;
    }
    module2.exports = {
      GnssFix,
      ...
      if (positionMessage.status == PositionStatus.SUCCESS || positionMessage.status == PositionStatus.NOT_SOLVABLE) {
        switch (positionMessage.positionType) {
          case PositionType.LR11xx_A_GNSS:
            positionMessage.lr11xxAGnss = util2.convertBytesToString(payload.slice(startingByte2 + 4));
            break;
    ...
    module2.exports = [
      {
        ...
        firmwareParameters: [
              ...
              properties: [
                {
                  ...
                  properties: [
                    ...
                    },
                    {
                      name: "fuota",
                      type: "PropertyBoolean",
                      description: "Firmware Update Over The Air"
                    }
                  ]
                },
                {
          ...
          {
            driverParameterName: "lrRbeaconType",
            groupId: "0x04",
            localId: "0x08",
            defaultValue: 2,
            description: "Recovery beacon type.",
            parameterType: {
              type: "ParameterTypeString",
              possibleValues: [
                "SHORT_ID",
          ...
          {
            driverParameterName: "lrRbeaconSosPeriod",
            groupId: "0x04",
            localId: "0x09",
            defaultValue: 0,
            unit: "s",
            description: "Recovery beacon period in SOS.",
            parameterType: {
              type: "ParameterTypeNumber",
              range: {
                minimum: 0,
          ...
          {
            driverParameterName: "lrRbeaconMotionPeriod",
            groupId: "0x04",
            localId: "0x0A",
            defaultValue: 0,
            unit: "s",
            description: "Recovery beacon period in motion.",
            parameterType: {
              type: "ParameterTypeNumber",
              range: {
                minimum: 0,
          ...
          {
            driverParameterName: "lrRbeaconStaticPeriod",
            groupId: "0x04",
            localId: "0x0B",
            defaultValue: 0,
            unit: "s",
            description: "Recovery beacon period in static.",
            parameterType: {
              type: "ParameterTypeNumber",
              range: {
                minimum: 0,
          ...
          {
            driverParameterName: "lrRbeaconRangingTimeout",
            groupId: "0x04",
            localId: "0x0C",
            defaultValue: 120,
            unit: "s",
            description: "Maximum timeout to exit the ranging mode.",
            parameterType: {
              type: "ParameterTypeNumber",
              range: {
                minimum: 120,
          ...
          },
          {
            ...
            groupId: "0x0A",
            localId: "0x19",
            description: "Authentication protocol used for private APN connection.",
            defaultValue: "",
            parameterType: {
              type: "ParameterTypeString",
              possibleValues: [
          ...
          {
            driverParameterName: "cellRestrictedPlmns",
            groupId: "0x0A",
            localId: "0x1B",
            defaultValue: "",
            description: "List of restricted Public Land Mobile Networks (PLMNs)",
            parameterType: {
              type: "ParameterTypeAsciiString",
              maxSize: 32
            },
          ...
          {
            driverParameterName: "bleBeaconSlowAdvInterval",
            groupId: "0x0B",
            localId: "0x07",
            defaultValue: 1e3,
...
var require_response = __commonJS({
  "../../device-catalog/vendors/abeeway/drivers/asset-tracker-3/src/messages/uplink/responses/response.js"(exports2, module2) {
    ...
    function Response(responseType, genericConfigurationSet, parameterClassConfigurationSet, genericConfigurationGet, parameterClassConfigurationGet, bleStatusConnectivity, configurationCrcRequest, sensorRequest, globalCrc, localCrc, fuotaStatus, recoveryBeaconKeyUpdateStatus, recoveryBeaconRootKeyIndex) {
    ...
    function determineResponse(payload, multiFrame) {
      ...
      switch (typeValue) {
        ...
        case 9:
          ...
          response.recoveryBeaconKeyUpdateStatus = decodeRecoveryBeaconKeyUpdateStatus(payload[startingByte2 + 1]);
          break;
        case 10:
          response.responseType = ResponseType.RECOVERY_BEACON_ROOT_KEY_INDEX_GET;
          response.recoveryBeaconRootKeyIndex = payload[startingByte2 + 1];
          break;
        default:
    ...
    function decodeRecoveryBeaconKeyUpdateStatus(value) {
      switch (Number(value)) {
        case 0:
          return "SUCCESS";
        case 1:
          return "FAILED_INVALID_ROOT_INDEX";
        case 2:
          return "FAILED_WRITING_ERROR";
        case 3:
          return "FAILED_SAVING_ERROR";
        default:
          throw new Error("Unknown recovery beacon key update status: " + value);
      }
    }
...
var require_command = __commonJS({
  "../../device-catalog/vendors/abeeway/drivers/asset-tracker-3/src/messages/downlink/command.js"(exports2, module2) {
    var SystemEventClass = Object.freeze({
      BUTTON_1: "BUTTON_1",
      BUTTON_2: "BUTTON_2",
      BUZZER: "BUZZER",
      ACCELEROMETER: "ACCELEROMETER",
...
var require_request = __commonJS({
  "../../device-catalog/vendors/abeeway/drivers/asset-tracker-3/src/messages/downlink/requests/request.js"(exports2, module2) {
    ...
    function Request(requestType, genericConfigurationSet, parameterClassConfigurationSet, genericConfigurationGet, parameterClassConfigurationGet, bleStatusConnectivity, crc, sensorIds, fuotaBinaryType, filePath, debugInfoType, k0Key, k1Key, rootKeyIndex) {
    ...
    function encodeRecoveryBeaconKeyUpdateRequest(k0Key, k1Key, rootKeyIndex, encData) {
      ...
      encData.push(rootKeyIndex & 255);
      return encData;
    }
    function encodeHexKey(hexStr, expectedBytes, encData) {
      const cleaned = hexStr.replace(/\s/g, "");
      if (cleaned.length !== expectedBytes * 2) {
        throw new Error("Key must be ".concat(expectedBytes, " bytes (").concat(expectedBytes * 2, " hex chars), got ").concat(cleaned.length / 2));
      }
...
let responseClass = __webpack_require__(971);
let util = __webpack_require__(96);
...
const FUOTA_BINARY_TYPES =(/* unused pure expression or super */ null && ({
    "APPLICATION" : 0,
    "BLE_STACK": 1,
    "MT3333": 2,
    "LR11XX": 3
...
let abeewayUplinkPayloadClass = __webpack_require__(416);
...
let systemClass = __webpack_require__(381);
let temperatureClass = __webpack_require__ (148)
let accelerometerClass = __webpack_require__(767)
let networkClass = __webpack_require__(656)
let geozoningClass = __webpack_require__(614)
let telemetryClass = __webpack_require__(705)
...
let util = __webpack_require__(96);
let BeaconInfoClass = __webpack_require__(726);
...
let TriggerBitMapClass = __webpack_require__(645);
let bleClass = __webpack_require__(946);
let util = __webpack_require__(96);
let gnssFixClass = __webpack_require__(26)
let gnssFailureClass = __webpack_require__(579)
let wifiClass = __webpack_require__(118);
const gnssFailure = __webpack_require__(579);
...
let BssidInfoClass = __webpack_require__(939);
let util = __webpack_require__(96);
...
let util = __webpack_require__(96);
let jsonParameters = __webpack_require__(901);
let accelerometer = __webpack_require__(767)
...
var base64 = __webpack_require__(968)
...
/* harmony export */ });
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(462);
...
/* harmony import */ var _messages_downlink_abeewayDownlinkPayload_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(552);
...
/* harmony import */ var _messages_downlink_command_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(409);
...
/* harmony import */ var _messages_downlink_requests_request_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(642);
...
/* harmony import */ var _messages_uplink_abeewayUplinkPayload_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(416);
...
/* harmony import */ var _messages_uplink_basicHeader_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(54);
...
/* harmony import */ var _messages_uplink_extendedHeader_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(769);
...
/* harmony import */ var _messages_uplink_notifications_accelerometer_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(767);
...
/* harmony import */ var _messages_uplink_notifications_geozoning_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(614);
...
/* harmony import */ var _messages_uplink_notifications_network_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(656);
...
/* harmony import */ var _messages_uplink_notifications_notification_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(667);
...
/* harmony import */ var _messages_uplink_notifications_system_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(381);
...
/* harmony import */ var _messages_uplink_notifications_telemetry_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(705);
...
/* harmony import */ var _messages_uplink_notifications_temperature_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(148);
...
/* harmony import */ var _messages_uplink_positions_ble_beaconInfo_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(726);
...
/* harmony import */ var _messages_uplink_positions_ble_blePosition_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(946);
...
/* harmony import */ var _messages_uplink_positions_gnss_gnssFailure_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(579);
...
/* harmony import */ var _messages_uplink_positions_gnss_gnssFix_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(26);
...
/* harmony import */ var _messages_uplink_positions_gnss_satelliteInfo_js__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(621);
...
/* harmony import */ var _messages_uplink_positions_position_js__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(707);
...
/* harmony import */ var _messages_uplink_positions_triggerBitMap_js__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(645);
...
/* harmony import */ var _messages_uplink_positions_wifi_bssidInfo_js__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(939);
...
/* harmony import */ var _messages_uplink_positions_wifi_wifiPosition_js__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(118);
...
/* harmony import */ var _messages_uplink_queries_query_js__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(418);
...
/* harmony import */ var _messages_uplink_responses_response_js__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(971);
...
/* harmony import */ var _messages_uplink_telemetry_telemetry_js__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(2);
...
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(96);
...
/* harmony import */ var buffer__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(617);
